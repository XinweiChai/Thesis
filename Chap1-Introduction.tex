...
If one has an existing model, he might want to know what kind of properties this model satisfies, such as fixed points, safety, reachability \textit{etc.}

As stated in the beginning of this chapter, the verification of such properties is costly in computation.
...
\begin{itemize}
    \item How to analyze efficiently and precisely the reachability properties within an asynchronous discrete model?
