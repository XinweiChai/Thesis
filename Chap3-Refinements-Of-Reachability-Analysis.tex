...
\begin{itemize}
    \item Why the inconclusiveness problem rises in static analysis methods%\roux{}{in our method}
    \item What are the problematic topological structures during static analysis %\roux{}{in Automata Networks or in what ?}
