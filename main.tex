...
Cependant, l'apprentissage et l'analyse de tels syst\`emes concurrents sont difficiles pour ce qui concerne les calculs.%\roux{en calcul}{pour ce qui concerne les calculs}.
