...
\begin{definition}[Automata Network with delay]
...
Take Process Hitting in Figure \ref{ExUnder} as example with initial state $\langle a_0,b_0,c_0,d_0\rangle$. Figure \ref{Under1}, Figure \ref{Under2} and Figure \ref{Under3} show the procedures of under-approximation: after two additions of actions and an update, the LCG becomes stable and $a_2$ is reachable.
\begin{figure}[!htbp]
\centering
\begin{tikzpicture}
\TSort{(3,0)}{a}{3}{l}
...
Tony's Algo: how does the asynchronous version work
