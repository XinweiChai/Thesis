\chapter{Refined Reachability Analysis \textit{via} Heuristics}
\begin{mybox}
...
This chapter is going to formally clarify the definition of Simplified LCG (SLCG) and \textbf{why}, modify the definitions of the modelings in order to make them more suited for our own reachability analyzers, then explain how their related static analysis functions.
...
With the definition of trajectory, we can now define the dynamics of an ABAN.
