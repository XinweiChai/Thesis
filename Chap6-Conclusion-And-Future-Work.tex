...
\begin{itemize}
    ...
    \item We are now considering the incorporation of parameter space abstraction, like the work of \cite{PRNs-TCS18}, to improve the performance of our model checkers regarding runtime.
