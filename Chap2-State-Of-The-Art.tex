...
let $V$ be the set of variables, $R$ the set of rules and current state $S=\langle var_0^{val_0},\cdots, var_n^{val_n}\rangle$. 
$V'=\{v\in V\mid \exists r\in R, body(r)\subseteq S, v= head(r)\}$, then $m=|V'|$.
